...
const accessTokenHasExpired = () => {
  const { myanimelist_access_token, myanimelist_expires_in, myanimelist_token_timestamp } = LOCALSTORAGE_ITEMS;
...
const getAccessToken = () => {
  ...
  if (hasError || accessTokenHasExpired() || LOCALSTORAGE_ITEMS.myanimelist_access_token === "undefined") {
  ...
  if (LOCALSTORAGE_ITEMS.myanimelist_access_token && LOCALSTORAGE_ITEMS.myanimelist_access_token !== "undefined") {
...
/**
 * Get current user's user informatiom
